...
//         reinterpret_cast<void*>(offsetof(CuboidInstance, model) +
//                                 model_row_size * i));
...
//   glVertexAttribPointer(
//       shininess_layout_index, 1, GL_FLOAT, GL_FALSE, sizeof(CuboidInstance),
...
//       sizeof(Internal::Vertex) * kCuboidVertices.size(),
//       (const std::byte*)(kCuboidVertices.data()));
//   verices_vbo_.Bind();
//   Internal::Vertex::BindAttributes();
//
//   instances_vbo_ = Internal::VertexBufferObject(0, nullptr,
//   kInstanceVboUsage); instances_vbo_.Bind();
//   CuboidInstance::BindAttributes();
//
//   ebo_ = Internal::ElementBufferObjectBuilder()
//              .Data(sizeof(GLuint) * kCuboidIndices.size(),
//                    (const std::byte*)(kCuboidIndices.data()))
//              .Build(vao_);
//   vao_.BindEbo(ebo_);
//   vao_.Unbind();
//
...
//
//   // resize VBO buffer
//   constexpr std::int64_t kChunkSize = 64;  // cubes are stored in chunks of
//   64
//
...
//         (cuboids_.size() + kChunkSize - 1) / kChunkSize * kChunkSize;
...
//       } else {
//         instances_[index] =
//             CuboidInstance{model, cuboid.diffuse_color,
//             cuboid.specular_color,
//                            cuboid.shininess};
//       }
//     }
...
//   //   ptr += updated_size;
//   //   instances_vbo_.SubData(prev_size * sizeof(CuboidInstance),
//   updated_size,
//   //                          ptr);
//   // }
//
