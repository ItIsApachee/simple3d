...
glm::mat4 ICamera::GetProj() { return glm::mat4(1.0f); }

glm::mat4 ICamera::GetView() { return glm::mat4(1.0f); }

glm::vec3 ICamera::GetViewPos() { return glm::vec3(0.0f); }
...
glm::vec3 Camera::GetViewPos() { return pos; }
